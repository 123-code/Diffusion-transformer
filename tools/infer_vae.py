...
from torchviion.utils import make_grid 
from tqdm import tqdm 
from dataset.celeb.celeb_dataset import CelebDataset 
...
def infer(args):
    ...
    with torch.no_grad():
        ...
        encoder_grid = torchvision.utils.ToPILImage()(encoder_grid)
        decoder_grid = torchvision.utils.ToPILImage()(decoder_grid)
        input_grid = torchvision.utils.ToPILImage()(input_grid)
