...
class DiT(nn.Module):
    def __init__(self, latent_dim=1024, dim=512, depth=6, heads=8, mlp_ratio=4):
        ...
        self.dim = dim
        self.depth = depth
        self.num_patches = latent_dim // dim 
        self.in_proj = nn.Linear(latent_dim, dim * self.num_patches)  
    ...
    def forward(self, noisy_latent, t):
        ...
        x = rearrange(self.in_proj(noisy_latent), 'b (n d) -> b n d', n=self.num_patches) 
